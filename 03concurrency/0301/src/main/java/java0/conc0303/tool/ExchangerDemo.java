 ...
 * 简单说就是一个线程在完成一定的任务后想与另一个线程交换数据，则第一个先拿出数据的线程会一直等待第二个线程，
 ...
 * <p>
 * 当一个线程到达 exchange 调用点时，如果其他线程此前已经调用了此方法，
        ...
        public void run() {
            for (int i = 1; i < 5; i++) {
                try {
                    ...
                    System.out.println(getName() + i + " 交换前:" + data);
                    data = exchanger.exchange(data);
                    System.out.println(getName() + i + " 交换后:" + data);
